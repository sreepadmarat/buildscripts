...
git clone -b infinity --depth=1 https://github.com/sreepadmarat/device_oneplus_larry device/oneplus/larry
git clone -b infinity --depth=1 https://github.com/sreepadmarat/device_oneplus_sm6375-common device/oneplus/sm6375-common
git clone -b infinity --depth=1 https://github.com/sreepadmarat/hardware_oplus hardware/oplus
...
rm -rf packages/apps/Updater
git clone -b GMS --depth=1 https://github.com/sreepadmarat/packages_apps_Updater packages/apps/Updater
